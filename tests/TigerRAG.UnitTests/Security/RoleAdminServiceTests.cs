...
public sealed class RoleAdminServiceTests
{
    ...
    public async Task RenameAsync_WithAdminName_ThrowsArgumentException()
    {
        ...
        var error = await Assert.ThrowsAsync<ArgumentException>(() =>
            service.RenameAsync("Admin", new RenameRoleRequest("SuperAdmin"), CancellationToken.None));
    ...
    public async Task RenameAsync_WithSameName_IsIdempotent()
    {
        ...
        var result = await service.RenameAsync("CustomRole", new RenameRoleRequest("CustomRole"), CancellationToken.None);
    ...
    public async Task RenameAsync_WithInvalidNewName_ThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            service.RenameAsync("CustomRole", new RenameRoleRequest("bad-role"), CancellationToken.None));
    }
    ...
    public async Task RenameAsync_WhenOldRoleMissing_ThrowsArgumentException()
    {
        ...
        var error = await Assert.ThrowsAsync<ArgumentException>(() =>
            service.RenameAsync("Ghost", new RenameRoleRequest("Whatever"), CancellationToken.None));
    ...
    public async Task RenameAsync_WhenNewNameTaken_ThrowsArgumentException()
    {
        ...
        var error = await Assert.ThrowsAsync<ArgumentException>(() =>
            service.RenameAsync("CustomRole", new RenameRoleRequest("OtherRole"), CancellationToken.None));
    ...
    public async Task RenameAsync_HappyPath_RenamesAndRotatesAffectedUsers()
    {
        ...
        var result = await service.RenameAsync("CustomRole", new RenameRoleRequest("RenamedRole"), CancellationToken.None);
