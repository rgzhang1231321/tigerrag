...
/// <summary>删除角色；后端在仍被用户/菜单引用或自我降级到最后一名 Admin 时拒绝。路径段做 URL 编码以兼容大小写角色名。</summary>
